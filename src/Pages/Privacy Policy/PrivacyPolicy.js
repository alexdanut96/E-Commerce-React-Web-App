  ...
  return (
    <div style={{ color: "white" }}>
      ...
      <div>
        ...
        fully with all applicable ROMANIAN Data Protection legislation and
      ...
      <div>We use the information in the following ways:</div>
      <div>Information you supply to us. We will use this information:</div>
      <ul>
        <li>
      ...
      <div>
        ...
        alexdanutdev@gmail.com. We will provide your personal data to you within
        the statutory time frames. To enable us to trace any of your personal
        data that we may be holding, we may need to request further information
      ...
      <div>
        ...
        welcomed and should be addressed to alexdanutdev@gmail.com.
      </div>
    </div>
  );
};
